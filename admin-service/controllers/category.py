...
@category_router.post("/api/admin/categories", response_model=CategoryRead, tags=["Category"])
...
@category_router.get("/api/admin/categories", response_model=List[CategoryRead], tags=["Category"])
...
@category_router.put("/api/admin/categories/{category_id}", response_model=CategoryRead, tags=["Category"])
...
@category_router.delete("/api/admin/categories/{category_id}", response_model=CategoryRead, tags=["Category"])
