...
@room_router.get("/api/admin/rooms", response_model=List[RoomRead], tags=["Room"])
...
@room_router.post("/api/admin/rooms", response_model=RoomRead, tags=["Room"])
...
@room_router.put("/api/admin/rooms/{room_id}", response_model=RoomRead, tags=["Room"])
...
@room_router.delete("/api/admin/rooms/{room_id}", response_model=RoomRead, tags=["Room"])
